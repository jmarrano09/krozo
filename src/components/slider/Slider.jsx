  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${
            process.env.PUBLIC_URL + "img/banner/glow4.jpg"
          })`,
        }}
      >
          ...
          <div className="row align-items-center full-screen">
            <div className="col-lg-12">
              <div className="hb-typo text-center">
                <h6>Hi There, I'm</h6>
                <h1 className="font-alt">Jess</h1>
                <h2>
                  <TextLoop>
                    <span className="loop-text">Frontend Developer</span>
                    <span className="loop-text"> UI/UX Designer</span>
                    <span className="loop-text">Web Designer</span>
                  </TextLoop>{" "}
                </h2>
              </div>
            </div>
